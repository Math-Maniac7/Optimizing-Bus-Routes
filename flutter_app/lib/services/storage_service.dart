...
class StorageService {
  ...
  static void clearGeneratedRouteData() {
    final data = getBusRouteData();
    if (data == null) return;

    data.remove('stops'); // generated by Phase 1
    data.remove('assignments'); // generated by Phase 2
    data.remove('routes'); // generated by Phase 3
    data.remove('evals'); // metrics

    saveBusRouteData(data);
  }

  /// Generates a hash from CSV content and bus data to detect changes
  static String generateStateHash(
    String? csvContent,
    ...
    return combined.length.toString() +
        (csvContent?.hashCode ?? 0).toString() +
        busData.hashCode.toString();
  }
}
